...
// Consulta para filtrar imágenes por categoría
...
if ($resultado->num_rows > 0) {
    ...
    $imagenes = []; // Si no hay resultados, inicializa el array de imágenes como vacío
}

// Consulta para obtener las categorías disponibles desde la tabla categorias_imagenes
...
<header>
    <h1>Reporte de Imágenes - Filtro por Categoría</h1>
</header>
...
<div class="container">
    ...
    <form method="GET" action="filtrar_imagenes.php">
        ...
        <table>
            ...
            <tbody>
                <?php foreach ($imagenes as $imagen): ?>
                    <tr>
                        <td><?php echo isset($imagen['id_imagen']) ? $imagen['id_imagen'] : 'N/A'; ?></td>
                        <td><?php echo isset($imagen['nombre_imagen']) ? $imagen['nombre_imagen'] : 'N/A'; ?></td>
                        <td><?php echo isset($imagen['url_imagen']) ? $imagen['url_imagen'] : 'N/A'; ?></td>
                        <td><?php echo isset($imagen['id_categoria']) ? $imagen['id_categoria'] : 'N/A'; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    ...
    <?php else: ?>
        <p>No se encontraron imágenes para este filtro.</p>
    <?php endif; ?>
</div>
...
function generarPDF() {
    ...
    <?php foreach ($imagenes as $imagen): ?>
        html += `
                <tr>
                    ...
                    <td><?php echo $imagen['url_imagen']; ?></td>
                    <td><?php echo $imagen['id_categoria']; ?></td>
                </tr>`;
    <?php endforeach; ?>
    ...
    html += `
        ...
        <footer>
            Generado automáticamente el <?php echo date('d-m-Y H:i'); ?>.
        </footer>
        </body>
        </html>`;
...
<footer>
    <p>Reporte generado para el sistema de imagenes</p>
</footer>
